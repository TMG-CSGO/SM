...
public void OnPluginStart()
{
	...
	*/
	...
	g_Cvar_Limits[0] = CreateConVar("sm_vote_map", "0.80", "percent required for successful map vote.", 0, true, 0.05, true, 1.0);
	g_Cvar_Limits[1] = CreateConVar("sm_vote_kick", "0.80", "percent required for successful kick vote.", 0, true, 0.05, true, 1.0);	
	g_Cvar_Limits[2] = CreateConVar("sm_vote_ban", "0.80", "percent required for successful ban vote.", 0, true, 0.05, true, 1.0);		
